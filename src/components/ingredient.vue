...
export default {
  ...
  data(){
    return {
      ...
      'Plums','Potatoes', 'Pumpkins','Radishes','Raspberries','Rhubarb','Rutabagas','Strawberries',
      'Spinach','Summer Squash','Sweet Potatoes & Yams','Swiss Chard','Turnips','Tomatillos','Tomatoes','Watermelon','Winter Squash','Zucchini'],
